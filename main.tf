...
locals {
  ...
  structure_replaced_resource_name5 = replace(local.structure_replaced_resource_name4, "WORK", var.workload_abbreviation)
  ...
  structure_replaced_resource_name8 = replace(local.structure_replaced_resource_name7, "ARCH", var.archetype)

  random_resource_name = (var.deployment_random_string == null ?
    "${local.structure_replaced_resource_name8}" :
    "${local.structure_replaced_resource_name8}${var.deployment_random_string}"
  )
...
locals {
  ...
  structure_replaced_resource_group_name5 = replace(local.structure_replaced_resource_group_name4, "WORK", var.workload_abbreviation)
  ...
  structure_replaced_resource_group_name8 = replace(local.structure_replaced_resource_group_name7, "ARCH", var.archetype)

  completed_resource_group_name = var.resource_group_name_overwrite ? var.resource_group_name : local.structure_replaced_resource_group_name8
